...
import dev.ngb.blogtruyen.exception.ClientErrorException;
import dev.ngb.blogtruyen.exception.ConflictException;
import dev.ngb.blogtruyen.exception.NotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ValidationErrorResponse handleValidationException(MethodArgumentNotValidException e, HttpServletRequest request) {
        ...
        groupedErrors.forEach((key, value) ->
                errors.add(ValidationErrorResponse.ValidationError.builder()
                        .field(key)
                        .messages(value)
                        .build())
        );
